...
<body class="cbp-spmenu-push">
	<div class="main-content">
            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						...
						<li class="">
							<a href="#"><i class="fa fa-book nav_icon"></i>类别管理<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="/admin/cates">浏览类别<span class="nav-badge-btm">08</span></a>
								</li>
								<li>
									<a href="/admin/cates/create">添加类别</a>
								</li>
							</ul>
							<!-- /nav-second-level -->
						</li>
						<li>
							...
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="/admin/goods">浏览商品<span class="nav-badge-btm">05</span></a>
								</li>
								<li>
						...
						<li>
							...
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="forms.html">待处理订单 <span class="nav-badge-btm">07</span></a>
								</li>
								<li>
									<a href="validation.html">待退款订单</a>
								</li>
								<li>
									<a href="validation.html">已处理订单</a>
								</li>
								<li>
									<a href="validation.html">历史订单</a>
								</li>
							</ul>
							<!-- //nav-second-level -->
						</li>
						<li>
							<a href="#"><i class="fa fa-file-text-o nav_icon"></i>活动管理<span class="nav-badge-btm">02</span><span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="login.html">发布活动</a>
								</li>
								<li>
									<a href="signup.html">历史活动</a>
								</li>
							</ul>
							<!-- //nav-second-level -->
					    ...
					    <li class="">
							<a href="#"><i class="fa fa-book nav_icon"></i>个人中心<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="general.html">个人资料<span class="nav-badge-btm">08</span></a>
								</li>
								<li>
									<a href="typography.html">退出</a>
								</li>
								<li>
									<a href="typography.html">登录</a>
								</li>
							</ul>
							<!-- /nav-second-level -->
						</li>
		...
		<!--footer-->
		<div class="footer">
		   <p>{{ date('Y-m-d')}}<a href="http://www.xhuolang.com/" target="_blank" title="">x-x-x-x</a> - Collect from <a href="http://www.cssmoban.com/" title="" target="_blank">~小货郎~</a></p>
		</div>
        <!--//footer-->
	</div>
	<!-- Classie -->
